export default {
  ...
  settings: {
    ...
    schedule_editor: {
      ...
      task_auto_link: "Автоприв’язка задач",
      task_auto_link_hint: "Оберіть, як прив’язувати задачі, створені з пари",
      task_auto_link_desc: "Працює для задач, створених з конкретної пари. Звичайна нова задача лишається незалежною, доки ви не оберете пару.",
      task_auto_link_selected: "Обрана пара",
      task_auto_link_next_same: "Наступна така пара",
