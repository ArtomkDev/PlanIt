export default {
  ...
  settings: {
    ...
    navigation_screen: {
      ...
      styles: {
        classic: { title: "Класична", desc: "Лаконічна панель на всю ширину без зайвого акценту" },
        island: { title: "Плаваючий острівець", desc: "Компактна округла панель у стилі сучасних iPhone" },
        material: { title: "Material", desc: "Стриманий Android-стиль із виразним індикатором вкладки" },
      },
    },
