...
// Pass required context data via props to break the import cycle
export default function SyncConflictScreen({ conflictQueue, handleResolveConflict }) {
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1 },
  header: { paddingHorizontal: 24, paddingTop: 40, paddingBottom: 20, alignItems: 'center' },
  headerIcon: { marginBottom: 16 },
  title: { fontSize: 24, fontWeight: '800', color: '#FFF', marginBottom: 12, textAlign: 'center' },
  subtitle: { fontSize: 15, color: '#A8A8B3', textAlign: 'center', lineHeight: 22 },
  scrollContent: { paddingHorizontal: 16, paddingBottom: 40 },
  card: { backgroundColor: '#1C1C1E', borderRadius: 20, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#2C2C2E' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: '#2C2C2E' },
  scheduleName: { fontSize: 18, fontWeight: '700', color: '#FFF', flex: 1 },
  badge: { backgroundColor: 'rgba(255, 77, 77, 0.15)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeText: { color: '#FF4D4D', fontSize: 12, fontWeight: '600' },
  btn: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 14, marginBottom: 10 },
  btnLocal: { backgroundColor: '#32D74B' },
  btnCloud: { backgroundColor: '#2C2C2E' },
  btnBoth: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#3A3A3C', borderStyle: 'dashed' },
  btnIconBoxLocal: { width: 40, height: 40, borderRadius: 10, backgroundColor: 'rgba(0,0,0,0.15)', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  btnIconBoxCloud: { width: 40, height: 40, borderRadius: 10, backgroundColor: '#3A3A3C', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  btnIconBoxBoth: { width: 40, height: 40, borderRadius: 10, backgroundColor: '#2C2C2E', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  btnTextBox: { flex: 1 },
  btnLocalText: { color: '#1C1C1E', fontWeight: '700', fontSize: 16, marginBottom: 2 },
  btnCloudText: { color: '#FFF', fontWeight: '700', fontSize: 16, marginBottom: 2 },
  btnBothText: { color: '#EBEBF5', fontWeight: '700', fontSize: 16, marginBottom: 2 },
  btnSubTextDark: { color: 'rgba(28, 28, 30, 0.6)', fontSize: 12 },
  btnSubTextLight: { color: '#8E8E93', fontSize: 12 }
});