export default {
  ...
  auth: {
    ...
    session: {
      expired_title: "Сеанс завершено",
      expired_message: "Ви вийшли з акаунту або сеанс було закрито з іншого пристрою.",
    },
    signup: {
  ...
  migration_modal: {
    ...
    subtitle: "Ймовірно, ви використовували PlanIt без авторизації і вирішили увійти в акаунт. Ми помітили розклади, чи перемістити їх до акаунту? Це дозволить зберігати їх в хмарі. Ви можете змінити це БУДЬ-КОЛИ!",
    skip: "Пропустити",
    migrate: "Перемістити",
    untitled: "Без назви"
  },
