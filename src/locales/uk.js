export default {
  ...
  tasks: {
    ...
    editor: {
      ...
      no_linked_lesson: "Без прив’язки до пари",
      unlink_lesson_hint: "Залишити задачу незалежною від розкладу",
      skip_lesson: "Пропустити пару",
      skip_lesson_hint: "Обрати лише дату для цього завдання",
